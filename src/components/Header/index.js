        ...
        <div className="row">
          ...
          <!-- ***** Menu Start ***** --> */}
              <ul className={`nav ${isMenuOpen ? "active" : ""}`}>
                ...
                <li className="scroll-to-section">
                  <a href="/"
                  onClick={() => handleHeaderItemClicked(servicesRef)}>
                    Services
                  </a>
                </li>
                <li className="scroll-to-section">
                  <a href="/" onClick={() => handleHeaderItemClicked(aboutRef)}>About</a>
                </li>
                <li className="scroll-to-section">
                  <a href="/" onClick={() => handleHeaderItemClicked(pricingRef)}>
                    Pricing
                  </a>
                </li>
                <li className="scroll-to-section">
                  <a href="/" onClick={() => handleHeaderItemClicked(newsLetterRef)}>
                    Newsletter
                  </a>
                </li>
                <li>
